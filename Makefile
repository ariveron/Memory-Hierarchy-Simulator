...
bin/memory-hierarchy-simulator: int/main.o int/CommandParser.o int/TraceConfig.o int/Trace.o int/TraceLogger.o int/SwapSubject.o int/CPU.o int/TLB.o
	g++ -o bin/memory-hierarchy-simulator int/main.o int/CommandParser.o int/TraceConfig.o int/Trace.o int/TraceLogger.o int/SwapSubject.o int/CPU.o int/TLB.o
